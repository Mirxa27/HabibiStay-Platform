...
-- CMS Permissions
('cms.pages.view', 'View CMS pages', 'cms'),
('cms.pages.create', 'Create CMS pages', 'cms'),
('cms.pages.edit', 'Edit CMS pages', 'cms'),
('cms.pages.delete', 'Delete CMS pages', 'cms'),
('cms.pages.publish', 'Publish CMS pages', 'cms'),
('cms.templates.view', 'View CMS templates', 'cms'),
('cms.templates.create', 'Create CMS templates', 'cms'),
('cms.templates.edit', 'Edit CMS templates', 'cms'),
('cms.templates.delete', 'Delete CMS templates', 'cms'),
('cms.components.view', 'View CMS components', 'cms'),
('cms.components.create', 'Create CMS components', 'cms'),
('cms.components.edit', 'Edit CMS components', 'cms'),
('cms.components.delete', 'Delete CMS components', 'cms'),
('cms.media.view', 'View CMS media', 'cms'),
('cms.media.upload', 'Upload CMS media', 'cms'),
('cms.media.delete', 'Delete CMS media', 'cms'),
('cms.ai.view', 'View CMS AI providers', 'cms'),
('cms.ai.create', 'Create CMS AI providers', 'cms'),
('cms.ai.edit', 'Edit CMS AI providers', 'cms'),
('cms.ai.delete', 'Delete CMS AI providers', 'cms'),
('cms.settings', 'Manage CMS settings', 'cms')
('cms.pages.edit', 'Edit CMS pages', 'cms'),
('cms.pages.delete', 'Delete CMS pages', 'cms'),
('cms.pages.publish', 'Publish CMS pages', 'cms'),
('cms.templates.view', 'View CMS templates', 'cms'),
